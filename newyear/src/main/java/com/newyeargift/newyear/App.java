package com.newyeargift.newyear;
...
public class App 
{
    public static void main( String[] args )
    {
        ...
        allsweets.add(new chocolates("diary milk", 10, 100, "dark"));
        allsweets.add(new chocolates("snickers", 13, 120, "dark"));
        allsweets.add(new chocolates("kitkat", 12, 120, "brown"));
        allsweets.add(new jelly("pineapple", 2, 30, "yellow"));
        allsweets.add(new jelly("apple", 2, 15, "green"));
        allsweets.add(new wraffers("strawberry", 25, 20, "pink"));
        allsweets.add(new chocolates("5 star", 10, 20, "brown"));
        allsweets.add(new jelly("mango", 22, 22, "yellow"));
        allsweets.add(new wraffers("perk", 150, 20, "orange"));
        allsweets.add(new wraffers("vanilla", 100, 10, "white"));
        allsweets.add(new candies("mango", 12,30,"yellow"));
        allsweets.add(new candies("blueberry", 30,70,"blue"));
